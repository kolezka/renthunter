...
<section class="animate-rise">
  <header class="mb-5 flex items-center justify-between gap-4">
    <div>
      ...
      <p class="m-0 text-[0.9rem] text-ink-3">Monitor event stream · auto-refresh every 5s</p>
    </div>
    <div class="flex gap-1 rounded-full border border-[var(--glass-border)] bg-[var(--glass-fill)] p-1" role="group" aria-label="Log filter">
      <button
