...
export const FEATURE_TAXONOMY: { canonical: string; aliases: string[] }[] = [
  { canonical: "umeblowane", aliases: ["furnished", "umeblowany", "umeblowany salon", "wyposażone", "w pełni wyposażone", "fully equipped", "fully equipped kitchen"] },
  { canonical: "gotowe do zamieszkania", aliases: ["ready to move in", "move-in ready", "do zamieszkania od zaraz"] },
  ...
  { canonical: "blisko parku", aliases: ["near park", "park nearby", "near the park"] },
